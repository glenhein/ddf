        ...
        if ((schema != null)) {
          ...
          if (!CollectionUtils.isEmpty(featureConverterFactories)) {
            ...
            if (featureConverter == null) {
              LOGGER.debug(
                  "WfsSource {}: Unable to find a feature specific converter; {} will be converted using the GenericFeatureConverterWfs11",
                  getId(),
                  ftName);
              featureConverter = new GenericFeatureConverterWfs11();
            }
          } else {
            LOGGER.debug(
                "WfsSource {}: Unable to find a feature specific converter; {} will be converted using the GenericFeatureConverterWfs11",
