...
import org.codice.ddf.spatial.ogc.wfs.v1_1_0.catalog.converter.impl.FeatureCollectionConverterWfs11;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

@Consumes({MediaType.TEXT_XML, MediaType.APPLICATION_XML})
@Provider
public class FeatureCollectionMessageBodyReaderWfs11
    implements MessageBodyReader<WfsFeatureCollection> {

  private static final Logger LOGGER =
      LoggerFactory.getLogger(FeatureCollectionMessageBodyReaderWfs11.class);

  protected XStream xstream;

  protected FeatureCollectionConverterWfs11 featureCollectionConverter;

  protected Map<String, FeatureConverter> featureConverterMap =
      new HashMap<String, FeatureConverter>();

  public FeatureCollectionMessageBodyReaderWfs11() {
    ...
    featureCollectionConverter = new FeatureCollectionConverterWfs11();
