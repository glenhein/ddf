 ...
 */
package org.codice.ddf.spatial.ogc.wfs.v1_1_0.catalog.converter.impl;
...
public class FeatureCollectionConverterWfs11 implements Converter {
  ...
  public FeatureCollectionConverterWfs11() {
    featureMember = "featureMember";
    prefixToUriMapping.put(Wfs11Constants.XSI_PREFIX, XMLConstants.W3C_XML_SCHEMA_INSTANCE_NS_URI);
    prefixToUriMapping.put(Wfs11Constants.WFS_NAMESPACE_PREFIX, Wfs11Constants.WFS_NAMESPACE);
    prefixToUriMapping.put(Wfs11Constants.GML_PREFIX, Wfs11Constants.GML_NAMESPACE);
  }
  ...
  public Object unmarshal(HierarchicalStreamReader reader, UnmarshallingContext context) {
    ...
    while (reader.hasMoreChildren()) {
      ...
      if ("featureMembers".equals(nodeName)) {
        reader.moveDown();
        while (reader.hasMoreChildren()) {
          featureCollection
              .getFeatureMembers()
